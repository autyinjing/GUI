...
const QMetaObjectExtraData Content::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Content::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_Content,
      qt_meta_data_Content, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Content::getStaticMetaObject() { return staticMetaObject; }
