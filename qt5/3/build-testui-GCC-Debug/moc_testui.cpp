...
const QMetaObjectExtraData testui::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject testui::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_testui,
      qt_meta_data_testui, &staticMetaObjectExtraData }
};
